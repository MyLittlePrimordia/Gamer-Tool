...
/// (built-in and user-saved alike), which two are currently active, and the
/// "Run on Startup" toggle. Serialized as plain JSON via System.Text.Json -
/// part of the BCL for net8.0-windows, so persistence stays zero-dependency.
/// </summary>
